...
{
    public class ApplicationQualityDbContext : AuditableContext, IApplicationQualityDbContext
    {
        private readonly IDateTimeService _dateTime;
        private readonly IAuthenticatedUserService _authenticatedUser;

        public ApplicationQualityDbContext(DbContextOptions<ApplicationQualityDbContext> options, IDateTimeService dateTime, IAuthenticatedUserService authenticatedUser) : base(options)
        {
            _dateTime = dateTime;
