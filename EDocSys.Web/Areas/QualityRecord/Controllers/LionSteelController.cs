...
using EDocSys.Application.Features.QualityFeatures.LionSteels.Commands.Delete;
...
namespace EDocSys.Web.Areas.QualityRecord.Controllers
{
    ...
    public class LionSteelController : BaseController<LionSteelController>
    {
        ...
        [Authorize(Policy = "CanViewQualityLionSteel")]
        ...
        [Authorize(Policy = "CanCreateEditQualityLionSteel")]
        ...
        public async Task<IActionResult> LoadAll1(int id)
        {
            ...
            if (response.Succeeded)
            {
                ...
                //    lionSteelViewModel.DocumentManualStatusView = StatusId.DocumentStatus.Name;
                //}
                //else
                //{
                //    lionSteelViewModel.DocumentManualStatusView = "New";
                //}

                //if (lionSteelViewModel.Concurred1 != null)
                //{
                //    var concurred1User = _userManager.Users.Where(a => a.Id == lionSteelViewModel.Concurred1).SingleOrDefault();
                //    lionSteelViewModel.Concurred1Name = concurred1User.FirstName + " " + concurred1User.LastName;
                //    lionSteelViewModel.Concurred1 = concurred1User.Id;
                //}

                //if (lionSteelViewModel.Concurred2 != null)
                //{
                //    var concurred2User = _userManager.Users.Where(a => a.Id == lionSteelViewModel.Concurred2).SingleOrDefault();
                //    lionSteelViewModel.Concurred2 = concurred2User.FirstName + " " + concurred2User.LastName;
                //}

                //if (lionSteelViewModel.ApprovedBy != null)
                //{
                //    var ApprovedByUser = _userManager.Users.Where(a => a.Id == lionSteelViewModel.ApprovedBy).SingleOrDefault();
                //    lionSteelViewModel.ApprovedBy = ApprovedByUser.FirstName + " " + ApprovedByUser.LastName;
                //}
