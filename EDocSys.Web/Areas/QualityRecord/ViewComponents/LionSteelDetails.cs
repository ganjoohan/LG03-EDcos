...
namespace EDocSys.Web.Areas.QualityRecord.ViewComponents
{
    public class LionSteelDetails : ViewComponent
    {
        private readonly ApplicationQualityDbContext db;
        public LionSteelDetails(ApplicationQualityDbContext context)
        {
            db = context;
        }
