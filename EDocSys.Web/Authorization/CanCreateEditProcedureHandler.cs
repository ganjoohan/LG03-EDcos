...
{
    public class CanCreateEditProcedureHandler : AuthorizationHandler<CanCreateEditProcedureRequirement>
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly ApplicationDbContext _dbContext;
        private readonly IdentityContext _identityContext;

        public CanCreateEditProcedureHandler(IHttpContextAccessor httpContextAccessor, ApplicationDbContext dbContext, IdentityContext identityContext)
        {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, CanCreateEditProcedureRequirement requirement)
        {
            ...
            var procedureCreate = HttpUtility.ParseQueryString(_httpContextAccessor.HttpContext.Request.QueryString.Value).Get("ce");
            ...
            if (!success && procedureCreate == "f11c9d1f-abbb-45a1-8d11-b0a5590e5893") // Create
            {
                context.Succeed(requirement);
                return Task.CompletedTask;
            }
            else if (procedureCreate == "bd773a2a-ffc6-4ed2-9ba3-c7ea631628be")   // Edit
            {
