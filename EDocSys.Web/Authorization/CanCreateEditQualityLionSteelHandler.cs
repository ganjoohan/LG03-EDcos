...
{
    public class CanCreateEditQualityLionSteelHandler : AuthorizationHandler<CanCreateEditQualityLionSteelRequirement>
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly ApplicationQualityDbContext _dbContext;
        private readonly IdentityContext _identityContext;

        public CanCreateEditQualityLionSteelHandler(IHttpContextAccessor httpContextAccessor, ApplicationQualityDbContext dbContext, IdentityContext identityContext)
        {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, CanCreateEditQualityLionSteelRequirement requirement)
        {
            ...
            else if (lionSteelCreate == "bd773a2a-ffc6-4ed2-9ba3-c7ea631628be")   // Edit
            {
                ...
                {
                    //if (lionSteel.CompanyId == user.UserCompanyId && documentManual.DepartmentId == user.UserDepartmentId)
