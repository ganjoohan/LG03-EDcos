...
{
    public class CanCreateEditDocumentManualHandler : AuthorizationHandler<CanCreateEditDocumentManualRequirement>
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly ApplicationDbContext _dbContext;
        private readonly IdentityContext _identityContext;

        public CanCreateEditDocumentManualHandler(IHttpContextAccessor httpContextAccessor, ApplicationDbContext dbContext, IdentityContext identityContext)
        {
        ...
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, CanCreateEditDocumentManualRequirement requirement)
        {
            ...
            var documentManualCreate = HttpUtility.ParseQueryString(_httpContextAccessor.HttpContext.Request.QueryString.Value).Get("ce");
            ...
            if (!success && documentManualCreate == "f11c9d1f-abbb-45a1-8d11-b0a5590e5893") // Create
            {
                context.Succeed(requirement);
                return Task.CompletedTask;
            }
            else if (documentManualCreate == "bd773a2a-ffc6-4ed2-9ba3-c7ea631628be")   // Edit
            {
