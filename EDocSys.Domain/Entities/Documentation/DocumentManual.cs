...
{
    public class DocumentManual : AuditableEntity
    {
        ...
        public ICollection<DocumentManualStatus> DocumentManualStatus { get; set; }

        public string DocManualStatusView { get; set; }
